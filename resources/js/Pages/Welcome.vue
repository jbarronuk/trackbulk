                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            Easily upload all of your tracking numbers at once, saving valuable time and reducing the chance of manual errors. This allows you to focus on other important areas of your business while the system handles the tracking.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    By identifying delivery issues before customers complain, you can resolve problems quickly and maintain a high level of service. This helps build trust and keeps your customers happy.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    We automatically check the delivery status of your items every day, ensuring you always have the latest information. You no longer need to manually track each shipment, improving efficiency and accuracy.
                                </p>
                            </div>
                        </div>
                    </div>
